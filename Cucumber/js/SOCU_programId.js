...
XMLHttpRequest.register("GET", '*/metadata/delivery/*/vod/editorials?*' + encodeURIComponent('"editorial.ProgramId":"') + '*"*', function(req) {
    this.intercept(req, function() {
        var response = JSON.parse(this.responseText);
        this.json({
          "editorials": [
              ...
              "technicals": [
                {
                  ...
                  "media": {
                    "AV_HarmonicOSPlaylistName": {
                      ...
                      "fileName": "http://nagra.com/programId.m3u8",
